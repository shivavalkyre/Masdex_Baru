    ...
    pool.query('SELECT Count(*) as total FROM tbl_stakeholders WHERE user_id = $1',[user_id] ,(error, results) => {
        ...
        }else
        {
            ...
            let sampleFile = request.files.logo;
             ...
             pool.query('INSERT INTO tbl_stakeholders (jenis_stakeholder,user_id,nama_lengkap,alamat_kantor,logo,npwp,telepon_kantor,unit_kantor) VALUES($1,$2,$3,$4,$5,$6,$7,$8)',[jenis_stakeholder,user_id,nama_lengkap,alamat_kantor,name,npwp,telepon_kantor,unit_kantor] ,(error, results) => {
                if (error) {
                    throw error
                }
...
const read = (request, response) => {
    ...
    pool.query('SELECT count(*) as total FROM tbl_stakeholders where is_delete=false', (error, results) => {
     ...
     var sql= 'SELECT * FROM tbl_stakeholders where is_delete=false ORDER BY id ASC'
...
const update = (request, response) => {
    ...
    pool.query('SELECT count(*) as total FROM tbl_stakeholders where id=$1 and is_delete=false', [id], (error, results) => {
        ...
        }else
        {
         ...
         pool.query('UPDATE tbl_stakeholders SET jenis_stakeholder=$1,user_id=$2,nama_lengkap=$3,alamat_kantor=$4,logo=$5,npwp=$6,telepon_kantor=$7,unit_kantor=$8,updated_at=$9 where id=$10'
         , [jenis_stakeholder,user_id,nama_lengkap,alamat_kantor,name,npwp,telepon_kantor,unit_kantor,update_time,id], (error, results) =>{
           if (error) {
              throw error
