...
const readDistress = (request, response) => {
    ...
    pool.query('SELECT count(*) as total FROM tbl_insaf_distress WHERE is_delete=false', (error, results) => {
      ...
      var sql = `SELECT tbl_insaf_distress.id, tbl_insaf_distress.no_jurnal, tbl_insaf_distress.tanggal, tbl_insaf_jenis_distress.id as id_jenis_distress, tbl_insaf_jenis_distress.jenis_distress, tbl_insaf_distress.sumber_informasi, tbl_insaf_sumber_informasi_awal.sumber_informasi_awal, tbl_insaf_distress.judul_distress, tbl_insaf_distress.lokasi_kejadian, tbl_insaf_distress.foto_kejadian_distress, tbl_insaf_distress.deskripsi_assesment, tbl_insaf_distress.waktu_kejadian, tbl_insaf_distress.waktu_selesai, tbl_insaf_distress.degree1, tbl_insaf_distress.minute1, tbl_insaf_distress.second1, tbl_insaf_distress.direction1, tbl_insaf_distress.degree2, tbl_insaf_distress.minute2, tbl_insaf_distress.second2, tbl_insaf_distress.direction2, tbl_insaf_distress.is_delete, tbl_insaf_distress.voyage_id FROM tbl_insaf_distress LEFT JOIN tbl_insaf_jenis_distress ON tbl_insaf_distress.jenis_distress = tbl_insaf_jenis_distress.id LEFT JOIN tbl_insaf_sumber_informasi_awal ON tbl_insaf_distress.sumber_informasi = tbl_insaf_sumber_informasi_awal.id WHERE tbl_insaf_distress.is_delete=false and tbl_insaf_distress.voyage_id>0 ORDER BY ${sort_by_table_req}.${sort_by_req} ${ sort_direction_req }`
      pool.query(
       sql,
        (error, results) => {
          if (error) {
...
const readDistressByVoyage = (request, response) => {
  const id = parseInt(request.params.id)
var sql = `SELECT tbl_insaf_distress.id, tbl_insaf_distress.no_jurnal, tbl_insaf_distress.tanggal, tbl_insaf_jenis_distress.id as id_jenis_distress, tbl_insaf_jenis_distress.jenis_distress, tbl_insaf_distress.sumber_informasi, tbl_insaf_sumber_informasi_awal.sumber_informasi_awal, tbl_insaf_distress.judul_distress, tbl_insaf_distress.lokasi_kejadian, tbl_insaf_distress.foto_kejadian_distress, tbl_insaf_distress.deskripsi_assesment, tbl_insaf_distress.waktu_kejadian, tbl_insaf_distress.waktu_selesai, tbl_insaf_distress.degree1, tbl_insaf_distress.minute1, tbl_insaf_distress.second1, tbl_insaf_distress.direction1, tbl_insaf_distress.degree2, tbl_insaf_distress.minute2, tbl_insaf_distress.second2, tbl_insaf_distress.direction2, tbl_insaf_distress.is_delete
       FROM tbl_insaf_distress 
       LEFT JOIN tbl_insaf_jenis_distress ON tbl_insaf_distress.jenis_distress = tbl_insaf_jenis_distress.id
...
const readDistressDetailAll = (request, response) => {
  ...
  pool.query('SELECT count(*) as total FROM tbl_insaf_distress_detail WHERE is_delete=false', (error, results) => {
    ...
    res.push({total:results.rows[0].total})
    // var sql=  'SELECT * FROM tbl_insaf_distress WHERE is_delete=false ORDER BY id DESC LIMIT '  + rows_req + ' OFFSET ' + offset
    var sql=  'SELECT i.distress_id, k.ship_name FROM tbl_insaf_distress_detail i left join tbl_masdex_kapal k on k.mmsi = i.mmsi  WHERE i.is_delete=false ORDER BY i.id DESC'
    pool.query(
     sql,
      (error, results) => {
        if (error) {
...
const readPelaporDistress = (request, response) => {
    ...
    pool.query('SELECT count(*) as total FROM tbl_insaf_pelapor_distress WHERE distress_id = $1 AND is_delete=false', [distress_id], (error, results) => {
      ...
      res.push({total:results.rows[0].total})
      // var sql=  'SELECT * FROM tbl_insaf_pelapor_distress WHERE is_delete=false ORDER BY id DESC LIMIT '  + rows_req + ' OFFSET ' + offset
      var sql=  `SELECT * FROM tbl_insaf_pelapor_distress WHERE distress_id = '`+distress_id+`' AND is_delete=false ORDER BY id DESC`
      pool.query(
       sql,
        (error, results) => {
          if (error) {
...
const deletePelaporDistress = (request, response) => {
  ...
  const getJenisDistress = (request, response) =>
  {
	  pool.query(`SELECT id, jenis_distress
				 ...
				 WHERE is_delete = '0'
				 ORDER BY jenis_distress DESC;`, (error, result) => 
				 {
					if (error) 
					{
						throw error;
