    ...
    pool.query('SELECT count(*) as total FROM tbl_insaf_entering_to_port where id=$1 and is_delete=false', [id], (error, results) => {
     ...
     pool.query('SELECT * FROM tbl_insaf_entering_to_port where id=$1 and is_delete=false',[id] ,(error, results) => {
          ...
          if (request.files) {
              ...
              complete_path1 = 'https://api-insafmasdex.disnavpriok.id/api/V1/dokumens/entering_to_port/dokumen_berthing/' + name1;
              console.log(__dirname);
          ...
          if (request.files) {
              ...
              complete_path2 = 'https://api-insafmasdex.disnavpriok.id/api/V1/dokumens/entering_to_port/dokumen_ppk/' + name2;
              console.log(__dirname);
